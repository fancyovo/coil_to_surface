...
- 2026-08-11: `codex/direct-alpha-fast-score` jobs `36448/36458` completed the local full-gradient calibration. The moving-axis QR-16k proxy failed as a formal total-score gradient: full-300 cosine was `0.237/-0.072` at `h=0.005/0.01`, while the two formal gradients themselves had cosine `0.209`. Its volume-QS gradient was nevertheless accurate (`0.908/0.886`) and coil gradient exact (`1.0`). Do not integrate this proxy into production Adam; ABI/default score remain unchanged. A one-level continuous-surface setup is intrinsically invalid, and FP32 alpha normal equations failed Cholesky; neither may be reused. Evidence and timing are in the current direct-alpha report and `reports/assets/local_score_gradient_exploration_20260811/`.
