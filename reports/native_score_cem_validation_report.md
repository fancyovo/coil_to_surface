...
$$
e_{\mathrm{QH}}
=\frac{E_{\mathrm{QH}}}{\sqrt{1^2+N_{\mathrm{FP}}^2}},
$$
...
| $e_{\mathrm{QH}}/E_{\mathrm{QP}}$ | 147.6 |
| QH 相对优势 | 0.00673 |
| QH helicity 总门控因子 | 0.1040 |

该候选刚好擦过 5% 的长期漂移阈值，磁面不大，$|\iota|<1$，而 QP 残差比单位
helicity 的 QH 残差小约 148 倍。它的最小线圈间距只有 3.78 mm、最大曲率约
...
$e_{\mathrm{QH}}/E_{\mathrm{QP}}=12.6$，仍明显是 QP。另一方面，$|\iota|\ge1$ 的候选中
最低 $e_{\mathrm{QH}}$ 为 5.146，对应的 QP 残差仅 0.01233。搜索没有发现 QH 纯度与
足够旋转变换同时成立的交集。
