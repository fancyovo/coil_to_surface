...
- 2026-08-12 branch `codex/direct-alpha-fast-score` validated single-RTX5090 query-batched local gradients. Full-coordinate Adam reached online `93.6304` at step 1710 (`15.352 s/step`); BFGS failed; fresh `K=64`, LR `0.02` was the best reduced estimator. Production SPSA remains unchanged. Evidence: commit `0552264` and `reports/direct_alpha_fast_score_feasibility_20260811.md`.
- Commit `c9213aa` made flow+score truly single-GPU and prefetched each accepted center plus 128 endpoints in one FP32 RK4-128 batch. The 200-step K64 sample reached online `93.0961`, independent `94.6202`, and passed complete evaluation at sample-specific `a=0.08,s=0.49`: volume `0.066596 m^3`, iota `1.46030`, dense L2 `1.392e-5`, normal P95 `1.979e-5`, face QA/QH/QP `4.745e-3/1.246e-6/4.814e-3`; DESC stayed nested and ended mean/P95/max `1.092e-3/2.476e-3/8.439e-3` at its 50-step limit. Artifacts: `reports/assets/local_gradient_single_gpu_200_full_eval_20260812/`.
- The actual step-1710 full-coordinate maximum, input SHA `9daff76f...`, completed the same contract with pinned library `7834a88d...`: independent score `94.81168`, sample-specific `a=0.08,s=0.49`, volume `0.066541 m^3`, iota `1.37556`, dense L2 `4.912e-6`, normal P95 `4.884e-6`, face QA/QH/QP `4.601e-3/1.258e-6/4.676e-3`. Poincare/direct/DESC plots are nested QH; DESC remained nested and ended mean/P95/max `4.518e-4/1.050e-3/2.684e-3`, but also hit 50 steps. All eight DESC images passed delivery validation. Artifacts: `reports/assets/local_query_batch_gradient_best936304_full_eval_20260812/`.
- Query-batch complete evaluations must pin score-library hash `7834a88d...`; shared `build_mixed` is stale. Jobs `36699/36701/36703/36705` and source jobs `36945/36947/36949/36951` ran no physics and are invalid; the former used the stale library and the latter failed dirty-worktree preflight. Valid replacements and exact comparisons are recorded in the current report.
