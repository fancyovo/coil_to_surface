...
- 2026-08-12 branch `codex/direct-alpha-fast-score` implemented the single-RTX5090 logical 600-query local-gradient API and experimental full-gradient Adam entry point through commit `62f8e7e`; production SPSA remains unchanged. Accepted job `36533` used full grid48/full 100000-point density, produced 600/600 `ok` endpoints in 7.87 s local-score time, and matched the intended coordinate-plus-discrete-surface-selection-omitted reference with 300-D cosine `0.992846`. Three-step job `36539` used formal-128/local-64 surface sampling, raised formal score `85.5045 -> 86.4115`, accepted every update with 600/600 `ok`, averaged 14.95 s/step, and left both GPUs idle. Library SHA-256 is `7834a88d5437ba9910c78bb0eb5483efc71134579624ee2cc74100297a5799a3`; evidence and figures are in `reports/direct_alpha_fast_score_feasibility_20260811.md` and `reports/assets/local_query_batch_gradient_20260812/`.
