...
- 2026-08-28 current root checkout is `codex/data-space-large-scale-validation` at `4398269`, 127 commits ahead of local `main` (`835e4d6`) with no tracked worktree changes; 608 untracked audit, bundle, temporary, and generated paths remain in place and must not be treated as source edits.
...
- Exact continuation restored all optimizer/RNG/prefetch state and completed
  ...
  proof of global optimality. This run's already fully evaluated best SHA-256 remains
...
### Fully accepted reference samples across score definitions

- 2026-08-28 correction: the earlier statement that iteration-4341 score
  `93.3672653` was still the highest fully evaluated sample is superseded.
  Under the current cubic-iota ABI-10 library SHA-256 `565c32073b145d97a1f2244705fb06e4b3458ce798cd74d0c97ee4e0129dc729`, trajectory sample `p107_37034_3_000018_step0150` independently scores `94.6368682`; input SHA-256 is `6ee6f8e1f0290ec49093596a5f95b7f2aac98c61d51af3cad59410a771b7e8c1`.
- Its sample-adaptive evaluation selected `a=0.08, s=0.49`, volume
  `0.066070 m^3`, iota `1.45637`, dense relative L2 `1.6029e-5`, and face
  QA/QH/QP `4.6328e-3 / 5.1707e-7 / 4.6934e-3`; `s=0.56` jumped to an inner branch and `s=0.64` failed the fixed GPU-ray point budget. Poincare and DESC remained nested; DESC force mean/P95/max fell to `5.9204e-4 / 1.4649e-3 / 3.7093e-3` but hit the 50-step cap. Evidence: `reports/qh_min_face_qh_full_evaluation_20260819.md`.
- The iteration-4341 QH sample remains the accepted long-run reference for
  the historical constant-iota objective: score `93.3672653`, input SHA-256
  `d4517e03d66913d958bfac88b42b7d56228a9717c4b445f5ac28f242b049cc29`, selected `a=0.08, s=0.49`, volume `0.0658787 m^3`, iota `1.53758`, and face QH `2.9965e-6`. Its physical evaluation remains valid, but its score is not directly comparable with the current objective. Evidence: sections 20--22 of `reports/qh_score_throughput_and_continuous_surface_plan.md`.
...
- 2026-08-28 current re-evaluation: the final archive content is 140611282 bytes with SHA-256 `2777e16f12a9447edd72ce3f627ada1d29949a58050d28f0618d368ead48fd81`, and the recorded ZIP CRC, 172 internal hashes, six package-path checks, checkpoint/sample verification, accounting verification, and 81 tests pass. However, the actual file is `package/PB24511935_17855136690_算力平台赛道_本科生队伍.zip`, while `SUBMISSION_MANIFEST.json`, `build_submission.ps1`, and the `.zip.sha256` sidecar name/reference use `PB24511935+17855136690+算力平台赛道+本科生队伍.zip`; reconcile this filename mismatch before submission.
