...
def parse_arguments(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    validate_qh_direction_count(args.random_directions)
    return args
...
def main() -> None:
    ...
    requested_protocol = describe_qh_optimization_protocol(
    ...
    if args.resume:
        validate_qh_resume_protocol(manifest.get("protocol"), requested_protocol)
        if manifest.get("repository") != current_repository:
            raise ValueError(
