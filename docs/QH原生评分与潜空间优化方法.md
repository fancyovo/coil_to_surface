...
当前生产默认使用 $48^3$ 的 $\psi$ 拟合网格、三次 $\iota(\rho^2)$ 和 mode 2 严格磁轴续接。QH 优化协议为 32 候选筛选、64 个新正交中心差分方向、200 步 Adam、$h=0.005$、学习率 0.02 和 FP32 RK4-128。第 6 节中明确标为 ABI-9 或 2 方向的实验是历史证据，其绝对分数和配置均不定义当前方法。
