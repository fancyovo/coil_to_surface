...
#SBATCH --job-name=local-score-grad
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CUDA_VISIBLE_DEVICES=0 python scripts/prepare_local_score_gradient_candidates.py \
  --center "step50=$project/reports/assets/qh_iota_cubic_adam200_35864/trajectory/step_0050.json" \
  --center "step120=$project/reports/assets/qh_iota_cubic_adam200_35864/trajectory/step_0120.json" \
  --center "step200=$project/reports/assets/qh_iota_cubic_adam200_35864/trajectory/step_0200.json" \
  --checkpoint "$checkpoint" \
  --output-dir "$run_root/candidates" \
  --direction-mode random \
  --direction-count 32 \
  --scales 0.0025,0.005,0.01 \
  --flow-steps 128
