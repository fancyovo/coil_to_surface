...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate and ABI-11-score the compact flexible v3 prior.")
    parser.add_argument("--output-dir", type=Path, required=True)
    parser.add_argument("--lib", type=Path, required=True)
    parser.add_argument("--total-count", type=int, default=3600)
    ...
    elapsed = time.perf_counter() - started
        ...
        "format": "axis_surface_prior_score_shard_v3",
        "protocol_id": args.protocol_id,
        "preset": PRESET,
